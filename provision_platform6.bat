...
DEL /Q /S ".\reference_data\p6box.data\parity\conf\app.json"
TYPE ".\reference_data\p6box.data\parity\conf\platform6_app1.json" > ".\reference_data\p6box.data\parity\conf\app.json"
ECHO|SET /p="%INSTANCE_ID%">> ".\reference_data\b2box5.data\parity\conf\app.json"
TYPE ".\reference_data\p6box.data\parity\conf\platform6_app2.json" >> ".\reference_data\p6box.data\parity\conf\app.json"

REM ## Update application.conf
ECHO applicationid=%INSTANCE_ID%>> ".\reference_data\p6box.data\conf\application.conf"

RMDIR /S /Q "\p6box.data\"
XCOPY /s /q ".\reference_data\p6box.data" "\p6box.data\"
...
docker cp c:/p6box.data/parity/instance psql-data:/opt/
docker stop psql-data
